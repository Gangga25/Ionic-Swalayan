<template>
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            ...
            <ion-card>
                <ion-card-content>
                    <ion-input v-model="cart.name" label="Nama Pelanggan" label-placement="floating" fill="solid" placeholder="Nama Pelanggan"></ion-input>
                    <ion-input v-model="cart.desc" label="Keterangan" label-placement="floating" fill="solid" placeholder="Masukan Keterangan"></ion-input>
                </ion-card-content>
            </ion-card>
